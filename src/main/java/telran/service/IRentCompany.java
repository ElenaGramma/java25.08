...
//Sprint1
	...
	Set<Car>getCarsByDriver(long lolicenseId);
	...
	RemovedCarData returnCar(String regNumber,long licenseId, LocalDate returnCar, int damagesPercent,int tankPercent);
	//Sprint4
